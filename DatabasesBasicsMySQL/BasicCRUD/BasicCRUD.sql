...
SELECT DISTINCT first_name, last_name, job_title FROM employees
...
SELECT IF(middle_name IS NOT NULL, CONCAT(first_name, ' ', middle_name, ' ', last_name), CONCAT(first_name, '  ', last_name)) AS full_name, job_title
FROM employees;
