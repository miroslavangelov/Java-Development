...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public OrderedCustomersRootDto getOrderedCustomers() {
        ...
        OrderedCustomersDto[] orderedCustomersDtos = this.modelMapper.map(customers, OrderedCustomersDto[].class);
        orderedCustomersRootDto.setOrderedCustomersDtos(orderedCustomersDtos);

        return orderedCustomersRootDto;
    }

    @Override
    public CustomerWithSalesRootDto getCustomerWithSalesDto() {
        ...
        CustomerWithSalesRootDto customerWithSalesRootDto = new CustomerWithSalesRootDto();
        customerWithSalesRootDto.setCustomerWithSalesDtos(customerWithSalesDtos);

        return customerWithSalesRootDto;
    }
}
