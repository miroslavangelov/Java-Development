...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public CategoriesByProductsCountRootDto categoriesByProductsCount() {
        ...
        CategoriesByProductsCountRootDto categoriesByProductsCountRootDto = new CategoriesByProductsCountRootDto();
        categoriesByProductsCountRootDto.setCategoriesByProductsCountDtos(categoryDtos);

        return categoriesByProductsCountRootDto;
    }
}
