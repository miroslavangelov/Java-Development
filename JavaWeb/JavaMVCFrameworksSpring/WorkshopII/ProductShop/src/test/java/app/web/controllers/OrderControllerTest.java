...
public class OrderControllerTest {
    ...
    @Test
    @WithMockUser
    public void myOrdersDetails() throws Exception {
        Order order = this.saveOrder();

        this.mvc.perform(get("/orders/my/details/" + order.getId()))
    ...
    @Test
    @WithMockUser(username = "pesho", authorities = {"ADMIN"})
    public void allOrdersDetails() throws Exception {
        Order order = this.saveOrder();

        this.mvc.perform(get("/orders/all/details/" + order.getId()))
                .andExpect(view().name("orders/order-details"))
                .andExpect(model().attributeExists("order"));
    }
    ...
    public void allOrdersDetailsWithModerator() throws Exception {
        Order order = this.saveOrder();
