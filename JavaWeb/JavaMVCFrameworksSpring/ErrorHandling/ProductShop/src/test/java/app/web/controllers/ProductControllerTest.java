...
public class ProductControllerTest {
    ...
    @Test
    @WithMockUser
    public void orderProductView() throws Exception {
        Product product = this.saveProduct();

        this.mvc.perform(get("/products/order/" + product.getId()))
                .andExpect(view().name("orders/order-product"))
                .andExpect(model().attributeExists("product"));
    }
    ...
    public void orderProduct() throws Exception {
        ...
        this.mvc.perform(post("/products/order/" + product.getId())
                ...
                .param("quantity","2"))
                .andExpect(view().name("redirect:/orders/my"));
