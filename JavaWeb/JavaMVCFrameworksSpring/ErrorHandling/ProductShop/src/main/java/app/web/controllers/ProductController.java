...
public class ProductController extends BaseController {
    ...
    @Autowired
    public ProductController(ProductService productService, CategoryService categoryService, ModelMapper modelMapper, OrderService orderService) {
    ...
    public ModelAndView orderAction(@PathVariable(name = "id") String id, @Valid @ModelAttribute OrderAddBindingModel orderAddBindingModel,
        ...
        if (bindingResult.hasErrors()) {
            return super.redirect("/products/order/" + id);
        }
