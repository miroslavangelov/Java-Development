...
public class UserServiceTest {
    ...
    public void registerUserWithCorrectValues() {
        ...
        boolean isRegistered = this.userService.registerUser(userRegisterBindingModel);
    ...
    public void registerUserWithNullValues() {
        ...
        boolean isRegistered = this.userService.registerUser(this.modelMapper.map(this.user, UserRegisterBindingModel.class));
